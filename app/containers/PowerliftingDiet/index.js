...
export default function PowerligtingDiet() {
  return (
    <>
      <body>
          ...
          <div className="row">
            <div className="col-2 collapse show d-md-flex pt-2 pl-0 min-vh-100" id="sidebar">
              <ul className="nav flex-column flex-nowrap overflow-hidden">
                ...
                <li className="nav-item">
                  <a className="nav-link text-truncate" href="/bulkindiet">
                    <i
                      className="fa fa-bar-chart"
                    />
                    {' '}
                    <span className="d-none d-sm-inline">Bulking diet</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-truncate" href="/weightlossdiet">
                    <i
                      className="fa fa-bar-chart"
                    />
                    {' '}
                    <span className="d-none d-sm-inline">Weight loss diet</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-truncate" href="/dietforfatloss">
                    <i
                      className="fa fa-bar-chart"
                    />
                    {' '}
                    <span className="d-none d-sm-inline">Diet for fat loss</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-truncate" href="/powerliftingdiet">
                    <i
                      className="fa fa-bar-chart"
                    />
                    {' '}
                    <span className="d-none d-sm-inline">Powerlifting diet</span>
                  </a>
                </li>
              </ul>
            </div>
